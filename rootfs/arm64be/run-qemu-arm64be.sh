...
skip_510="imx8mp-evk:defconfig:be:smp4:mem2G:net=default:initrd \
	...
	imx8mp-evk:defconfig:be:smp4:mem2G:usb:net=default:ext2"
skip_515="imx8mp-evk:defconfig:be:smp4:mem2G:net=default:initrd \
	imx8mp-evk:defconfig:be:smp4:mem2G:sdb2:net=default:ext2 \
	imx8mp-evk:defconfig:be:smp4:mem2G:virtio-pci:net=default:ext2 \
	imx8mp-evk:defconfig:be:smp4:mem2G:virtio:net=default:ext2 \
	imx8mp-evk:defconfig:be:smp4:mem2G:usb:net=default:ext2"
